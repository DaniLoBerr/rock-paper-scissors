...
1. Create the game "Rock, Paper, Scissors".
    ...
    1.4. The outputs are going to be:
        ...
        1.4.2. A prompt for the user to enter his choice.
...
// Step 5: PLAY THE ENTIRE GAME LOGIC
...
// Move your playRound function and score variables so that they’re declared inside of the new playGame function.
  ...
  // Make a loop to play until one of the players reaches 5 points by calling playRound as many times as necessary.
  while (humanScore < 5 && computerScore < 5) {
    playRound(getComputerChoice(), getHumanChoice());
  }

  // Make a condition to display a message with the winner
  if (humanScore === 5) {
    console.log("Congrats! You win the game!");
  } else if (computerScore === 5) {
    console.log("I'm sorry, computer wins... Maybe next time.");
  }
  ...
  // Display the current scoreboard.
    if (
      ...
      return(
        console.log(
          `You lose! ${humanChoice} isn't a valid choice. 
          Computer ${computerScore} - ${humanScore} User`
        )
      );
      ...
      return(
        console.log(
          `It's a tie! 
          Computer: ${computerScore}, User: ${humanScore}.`
        )
      );
...
// Display a welcome message of the game
